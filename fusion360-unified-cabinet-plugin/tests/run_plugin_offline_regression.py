...
def main() -> int:
    ...
    code = run(
        [
            ...
            "tests.test_lay_flat_orientation",
            "tests.test_lay_flat_face_up",
            "tests.test_lay_flat_analyze",
            "tests.test_lay_flat_check_transaction",
            "tests.test_lay_flat_export_ready",
            "tests.test_panel_source_ref",
            "tests.test_panel_body_resolver",
            "tests.test_milling_surface_propagation",
            "tests.test_nesting_workpiece_name",
            "tests.test_manufacturing_snapshot_export",
